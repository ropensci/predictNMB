...
#' @srrstats {EA3.0} \code{plot()} and \code{make_summary_table()} allow for
...
#' @srrstats {EA3.1} \code{plot()} and \code{make_summary_table()} allow for
...
#' 'predictNMBscreen' both include \code{print} and \code{plot} methods.
#' Currently, there is no summary method but there is a
#' \code{make_summary_table()} method to perform and return aggregations in
#' tabular form.
#'
#'
"_PACKAGE"
