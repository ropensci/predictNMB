...
[![Codecov test coverage](https://codecov.io/gh/RWParsons/predictNMB/branch/master/graph/badge.svg)](https://app.codecov.io/gh/RWParsons/predictNMB?branch=master)
...
The [`predictNMB` website](https://rwparsons.github.io/predictNMB/) and its vignettes:

- [Getting started with `predictNMB`](https://rwparsons.github.io/predictNMB/articles/predictNMB.html)
- [Summarising results from `predictNMB`](https://rwparsons.github.io/predictNMB/articles/summarising-results-with-predictNMB.html)
- [Detailed example: pressure injury model](https://rwparsons.github.io/predictNMB/articles/detailed-example.html)
- [Creating NMB functions](https://rwparsons.github.io/predictNMB/articles/creating-nmb-functions.html)
