...
- `cl`: (Optional) users can pass a cluster as the. If it is passed, the simulations are run in parallel (faster).
...
- [Introduction to `predictNMB`](https://rwparsons.github.io/predictNMB/articles/introduction-to-predictNMB.html)
