...
## Related work
This R package is based on previous work on cost-effective cutpoints for the economic evaluation of clinical prediction models. It can be accessed here (insert link).
