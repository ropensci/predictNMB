...
Evaluating a hypothetical model for predicting and preventing an adverse event using a confusion matrix (2 x 2 table).
...
- `n_valid`: number of samples for validation dataset within each simulation (evaluating the NMB under each cutpoint)
