...
`{predictNMB}` was born out of related work that investigates cutpoint selection methods that maximise the NMB and includes several options for inbuilt and user-specified cutpoint selection functions. 
