...
The `shape` argument controls the shape aesthetic in `geom_point()`. It can also be mapped to whether the point is "cost-effective" (falls beneath the cost-effectiveness plane/WTP line) or the cutpoint "method".
```{r}
ce_plot(do_nmb_sim_obj, ref_col = "none", shape = 15)
ce_plot(do_nmb_sim_obj, ref_col = "none", shape = "square")
ce_plot(do_nmb_sim_obj, ref_col = "none", shape = "cost-effective")
