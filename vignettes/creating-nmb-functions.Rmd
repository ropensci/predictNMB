...
plot_nmb_dist <- function(f, n = 10000) {
  data <- do.call("rbind", lapply(1:n, \(x) f()))
...
foo2_remake <-
  get_nmb_sampler(
    outcome_cost = \() rgamma(n = 1, shape = 4),
    high_risk_group_treatment_cost = \() rgamma(n = 1, shape = 1),
    high_risk_group_treatment_effect = \() rbeta(n = 1, shape1 = 10, shape2 = 10)
  )
...
foo3_remake <-
  get_nmb_sampler(
    ...
    high_risk_group_treatment_cost = \() rgamma(n = 1, shape = 1),
    high_risk_group_treatment_effect = \() rbeta(n = 1, shape1 = 10, shape2 = 10),
    low_risk_group_treatment_cost = \() rgamma(n = 1, shape = 0.5 * 10, rate = 1 * 10),
    low_risk_group_treatment_effect = \() rbeta(n = 1, shape1 = 10, shape2 = 30)
  )
