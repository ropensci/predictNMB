...
#' @srrstats {G1.1} Method to simulate clinical prediction model from AUC
#' is described below with citation to method.
#' @srrstats {G2.0a} Differences between do_nmb_sim() and screen_simulation_inputs()
#' regarding input lengths is documented here and in introduction vignette.
```
